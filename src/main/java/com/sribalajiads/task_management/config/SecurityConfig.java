...
import com.sribalajiads.task_management.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/v1/auth/**", "/api/v1/health").permitAll() // Allow Login & Health Check
    ...
    public AuthenticationProvider authenticationProvider() {
        // Use no-arg constructor + setters to avoid any version conflicts
